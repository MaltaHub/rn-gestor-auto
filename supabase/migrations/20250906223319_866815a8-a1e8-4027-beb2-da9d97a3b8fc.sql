-- Complete Multi-Tenant Security Implementation (Fixed)

-- 1. Drop and recreate view_veiculos_expandidos with proper structure
DROP VIEW IF EXISTS view_veiculos_expandidos;

CREATE VIEW view_veiculos_expandidos AS
SELECT 
    v.id,
    v.hodometro,
    v.estado_venda,
