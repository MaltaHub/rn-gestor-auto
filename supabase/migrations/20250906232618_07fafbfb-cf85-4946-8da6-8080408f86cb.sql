-- Fix the function to use the correct column name 'ativo' instead of 'status'
...
BEGIN
    ...
    -- Get the tenant_id for the current user from tenant_members using correct column name
