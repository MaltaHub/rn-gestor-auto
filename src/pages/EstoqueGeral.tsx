    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Todos os veículos do tenant</p>
        </div>
      ...
      <Card className="shadow-card">
        <CardHeader>
          <CardTitle>Veículos no Estoque Geral</CardTitle>
          <CardDescription>Lista completa de todos os veículos do tenant</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
